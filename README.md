...
- 'circuit1.qasm' - **Phase oracle** (3 qubits): marks |111⟩ with a −1 phase using the H·CCX·H sandwich. The fundamental building block — proves the phase-flip mechanism works in isolation
